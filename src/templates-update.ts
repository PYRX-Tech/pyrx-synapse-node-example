...
const updated = await synapse.templates.update('order-confirmation', {
  subject: 'Order {the order ID} confirmed!',
  body_html: '<h1>Updated!</h1><p>Your order is confirmed.</p>',
});
